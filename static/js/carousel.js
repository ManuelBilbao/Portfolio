(function($) {
  ...
  class Carousel extends Component {
    ...
    constructor(el, options) {
      ...
      // Setup
      this.hasMultipleSlides = this.$el.find('.mat-carousel-item').length > 1;
      ...
      this.$el.find('.mat-carousel-item').each((el, i) => {
        this.images.push(el);
        if (this.showIndicators) {
    ...
    _handleResize(e) {
      if (this.options.fullWidth) {
        this.itemWidth = this.$el
          ...
          .first()
          .innerWidth();
        this.imageHeight = this.$el.find('.mat-carousel-item.active').height();
    ...
    _setCarouselHeight(imageOnly) {
      let firstSlide = this.$el.find('.mat-carousel-item.active').length
        ? this.$el.find('.mat-carousel-item.active').first()
        : this.$el.find('.mat-carousel-item').first();
    ...
    _scroll(x) {
      ...
      if (!this.noWrap || (this.center >= 0 && this.center < this.count)) {
        ...
        if (!$(el).hasClass('active')) {
          this.$el.find('.mat-carousel-item').removeClass('active');
      ...
      // onCycleTo callback
      let $currItem = this.$el.find('.mat-carousel-item').eq(this._wrap(this.center));
