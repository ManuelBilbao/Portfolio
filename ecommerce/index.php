...
$caracteristicas = [
	[
		...
		"titulo" => "Éxito",
		"descripcion" => "Trascienda las fronteras y expanda su negocio a nivel provincial, nacional e internacional. La tienda online no solo le permite mostrar sus productos y servicios a sus clientes, sino que también les facilita la experiencia de compra.",
